        ...
        <div class="col-12">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                    <nav class="navbar navbar-light p-2 " style="background-color: #f0f0f0;">
                        ...
                        <h6 class="mt-2 ms-2">จัดการรายชื่อผู้ผ่านอบรม</h6>
                    </nav>
                    <!-- <div class="btn-toolbar">
                        <a href="add_end.php" class="btn btn-primary my-4 "style="margin-right: 90px;"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล </a>
                    </div> -->
                </div>
                <br><br>
                ...
                <div class="card mb-4" style="margin-right: 80px;">
                    <div class="card-header">
                        ...
                        แสดงรายชื่อผู้ผ่านอบรม
                        <div class="mt-2 d-flex">
                            <a class="nav-link text-dack" href="end.php" role="button"> จัดการรายชื่อผู้ผ่านอบรม</a>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="edit_end.php" method="post">
                                            <input type="hidden" name="edit_id" value="<?php echo $row['end_id']; ?>">
                                            <button type="submit" name="edit_btn" class="btn btn-warning"><i class="bx bxs-edit"></i></a></button>
                                        </form>
                                    </td>
                                    <td><a href="delete_end.php?end_id=<?= $row["end_id"] ?>" class="btn btn-danger" onclick="Delete(this.href);return false;"><i class="bx bxs-trash"></i></a></td>
                                </tr>
