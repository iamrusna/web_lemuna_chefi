                                ...
                                <div class="col-lg-6">
                                    <div class="card shadow-lg border-0 rounded-lg">
                                        <div class="card-header" style="background-color: #ffffff;">
                                            <div class="card-body">
                                                <form class="row g-3" method="POST" action="add_insert_announce.php" enctype="multipart/form-data">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="name" name="announce_course_name" class="form-control" placeholder="ชื่อ" required>
                                                        </div>
                                                    </div>
