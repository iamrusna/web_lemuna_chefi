            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
                    <nav class="navbar navbar-light p-2 " style="background-color: #f0f0f0;">
                        ...
                        <h6 class="mt-2 ms-2">จัดการข้อมูลผู้สมัคร</h6>
                    </nav>
                    <!-- <div class="btn-toolbar">
                        <a href="add_applicant.php" class="btn btn-primary my-4 "style="margin-right: 90px;"><i class="fas fa-user-plus"></i> เพิ่มข้อมูล </a>
                    </div> -->
                </div>
                <br><br>
                ...
                <div class="card mb-4" style="margin-right: 80px;">
                    <div class="card-header">
                        ...
                        <div class="mt-2 d-flex">
                            <a class="nav-link text-dack" href="applicant.php" role="button"> จัดการข้อมูลผู้สมัคร</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <table id="datatablesSimple" class="table table-striped center">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><a href="delete_applicant.php?applicant_id=<?= $row["applicant_id"] ?>" class="btn btn-danger" onclick="Delete(this.href);return false;"><i class="bx bxs-trash"></i></a></td>
                                </tr>
