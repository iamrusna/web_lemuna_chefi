                                                ...
                                                <form class="row g-3" method="POST" action="add_insert_applicant.php" enctype="multipart/form-data">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="name" name="applicant_course_name" class="form-control" placeholder="ชื่อ" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="applicant_detail" class="form-control" placeholder="เบอร์โทรศัพท์" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="name" name="applicant_date" class="form-control"  placeholder="R" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="number" name="applicant_time" class="form-control" placeholder="1" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mt-4 text-center d-grid gap-2 col-6 mx-auto">
                                                        ...
                                                        <a href="applicant.php" class="btn btn-danger py-2"> ยกเลิก </a>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
